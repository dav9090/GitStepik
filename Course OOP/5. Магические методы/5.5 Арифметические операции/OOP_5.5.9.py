...
https://github.com/python-generation/OOP/tree/main/Module_5/Module_5.5/Module_5.5.9
'''
...
class FoodInfo:
    ...
    def __repr__(self):
        return '{}({}, {}, {})'.format(self.__class__.__name__, self.proteins, self.fats, self.carbohydrates)
