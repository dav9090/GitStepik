'''
https://github.com/python-generation/OOP/tree/main/Module_5/Module_5.10/Module_5.10.14
'''
...
class Row:
    ...
    def __eq__(self, other):
        ...
        return hash(tuple(self.__dict__.items())) == hash(tuple(other.__dict__.items()))
