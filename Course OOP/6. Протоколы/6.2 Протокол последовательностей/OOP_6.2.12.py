...
https://github.com/python-generation/OOP/tree/main/Module_6/Module_6.2/Module_6.2.12
'''

class CyclicList:
    def __init__(self, iterable=None):
        self._lst = list(iterable) if iterable else []
    ...
    #     self._lst[index % len(self._lst)] = value
